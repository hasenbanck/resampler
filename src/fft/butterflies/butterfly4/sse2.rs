...
/// Performs a single radix-4 Stockham butterfly stage for stride=1 (out-of-place, SSE2).
///
...
pub(super) unsafe fn butterfly_radix4_stride1_sse2(
    src: &[Complex32],
    dst: &mut [Complex32],
    ...
    unsafe {
        for i in (0..simd_iters).step_by(2) {
            ...
            // XOR to flip sign of imaginary part: -0.0 has sign bit set.
            let sign_mask = _mm_set_ps(-0.0, 0.0, -0.0, 0.0);
            let a3 = _mm_xor_ps(a3_swapped, sign_mask);
            ...
            // We have 4 outputs (out0, out1, out2, out3), each containing 2 complex numbers
            ...
            // After unpack: out01_lo = [out0[0], out1[0]], out23_lo = [out2[0], out3[0]]
...
/// Performs a single radix-4 Stockham butterfly stage for p>1 (out-of-place, SSE2).
///
...
#[target_feature(enable = "sse2")]
pub(super) unsafe fn butterfly_radix4_generic_sse2(
    src: &[Complex32],
    dst: &mut [Complex32],
    stage_twiddles: &[Complex32],
    stride: usize,
