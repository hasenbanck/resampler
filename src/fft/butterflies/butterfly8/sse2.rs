...
use crate::fft::{
    Complex32,
    butterflies::ops::{
        complex_mul_i_sse2, complex_mul_sse2, load_neg_imag_mask_sse2, load_scale_sse2, v8x_sse2,
        w8x_sse2,
    },
};

/// Performs a single radix-8 Stockham butterfly stage for stride=1 (out-of-place, SSE2).
///
...
pub(super) unsafe fn butterfly_radix8_stride1_sse2(
    src: &[Complex32],
    dst: &mut [Complex32],
    ...
    unsafe {
        ...
        for i in (0..simd_iters).step_by(2) {
            ...
            let even_a3 = complex_mul_i_sse2(t2_sub_t6, neg_imag_mask);
            ...
            let odd_a3 = complex_mul_i_sse2(t3_sub_t7, neg_imag_mask);
            ...
            let w8_1_odd_1 = w8x_sse2(x_odd_1, neg_imag_mask, scale);
            ...
            let w8_2_odd_2 = complex_mul_i_sse2(x_odd_2, neg_imag_mask);
            ...
            let w8_3_odd_3 = v8x_sse2(x_odd_3, neg_imag_mask, scale);
...
/// Performs a single radix-8 Stockham butterfly stage for p>1 (out-of-place, SSE2).
///
...
#[target_feature(enable = "sse2")]
pub(super) unsafe fn butterfly_radix8_generic_sse2(
    src: &[Complex32],
    dst: &mut [Complex32],
    stage_twiddles: &[Complex32],
    stride: usize,
