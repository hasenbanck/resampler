//! SSE2 optimized FIR convolution implementations.

/// SSE2 implementation of dual-phase FIR convolution with interpolation.
#[target_feature(enable = "sse2")]
pub(crate) unsafe fn convolve_interp_sse2(
    input: &[f32],
    coeffs1: &[f32],
    coeffs2: &[f32],
    frac: f32,
    ...
    unsafe {
        ...
        let shuf = _mm_shuffle_ps(interpolated, interpolated, 0b01_00_11_10);
        let sum1 = _mm_add_ps(interpolated, shuf);
